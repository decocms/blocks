...
- **Types and SEO/section primitives** — `ResolvedSection`, `DeferredSection`, `PageSeo`, `registerSeoSections`, `extractSeoFromProps`, `extractSeoFromSections`, `resolvePageSeoBlock` — import from `@decocms/runtime/cms`, a separate package.
...
import type { ResolvedSection, DeferredSection } from "@decocms/runtime/cms";
...
export {
  ...
  // ... all existing exports — see packages/runtime/src/cms/index.ts
};
```
...
### `Cannot find module '@decocms/tanstack'` or `'@decocms/runtime/cms'`
...
```typescript
import { registerSeoSections } from "@decocms/runtime/cms";
