...
import { registerSections, setBlocks } from "@decocms/runtime/cms";
...
describe("createDecoPage (next)", () => {
  it("resolves and renders the page for the current path", async () => {
    // registerSections (the async-loader registry, packages/runtime/src/cms/registry.ts)
    ...
    // (packages/runtime/src/cms/loader.ts) filters on. The plan's sketch used
