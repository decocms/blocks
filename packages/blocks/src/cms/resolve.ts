 ...
 * `@decocms/blocks-cli/scripts/cdn-rules.ts`. Two hand-maintained copies of
 * this list would silently drift, and the failure mode is a crawler's eager
 * HTML (~10x larger) being served to humans from the CDN, or the deferred one
 * being served to Google.
 */
