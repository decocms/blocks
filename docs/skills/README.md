...
Combine HTML prefetch-on-hover (nav links, using instant.page/quicklink) with SPA Link wrapper prefetch (product cards) for perceived performance gains.
...
- a production VTEX storefront — TanStack Start + React + VTEX, Deco framework
